<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ratingprocess.aspx.vb" Inherits="ratingprocess" %>
...
Serving the Islamic Ummah
    ...
    <ul class="sub">               
                                    ...
                                    <li><a href="whyrating.aspx" >Why Ratings?</a></li>
                                     <li><a href="ratingprocess.aspx" class="current">Rating process</a></li>
...
<div class="about-wrapper site-width ">
   ...
   <div class="about-sidebar">
              ...
              <!-- .box -->
                        ...
                        <div id="cp"></div>
                        <h1 class="box-title">Rating Process</h1>
                        <br/>
                        <p>
                            <img src="images/Rating%20Process.png" />
                                                </p>        
                                        
                        <p>* Consent of the client is only required for initial rating actions. For subsequent /surveillance rating actions, public ratings are disclosed even if client consent has not been received

</p><br />
<p>** If the company believes that certain information influencing the rating was not conveyed adequately by them or some later developments need to be taken into consideration by the committee, an appeal is made within two days of the assignment of the rating. The appeal process is designed to address specific points relating to the rating decision, and hence, the appeal meeting is tightly focused. The analyst will incorporate new information into the analysis,, which is then reconsidered by the rating committee. The committee may decide the new information(to be provided within 10 days of the appeal) warrants a rating change, or it may stand by its original rating decision. The rating decision on appeal is final. </p><br />
                  </div> <!-- .box -->

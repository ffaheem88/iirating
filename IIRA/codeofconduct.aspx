<%@ Page Language="VB" AutoEventWireup="false" CodeFile="codeofconduct.aspx.vb" Inherits="codeofconduct" %>
...
<div class="about-wrapper site-width ">
   ...
   <div class="about-sidebar">
                    <ul>
                                    ...
                                    <li><a href="codeofconduct.aspx"  class="current">Investment Policy</a></li>
                                    <li><a href="policies.aspx">Dissemination Of Ratings</a></li>
                                    <li><a href="ratingcomconduct.aspx">Rating Committee </a></li>
                                    <li><a href="ratingappeal.aspx">Rating Appeal</a></li>
                                    <li><a href="ratingFeePolicy.aspx">Rating Fee Policy</a></li>
              ...
              <!-- .box -->
                        ...
                        <div id="cp"></div>
                        <h1 class="box-title">PERSONAL AND CORPORATE INVESTMENT POLICY</h1>
                        <br/>
                        <p>	•		Employees and dependent family members are directed to refrain from investment in any issuances of client firms. Declaration to this effect is made by all staff members, engaged in business acquisition and analytical processes, on a semi-annual basis.    </p><br />
                     <p>	•	Employees are further expected to declare any relationship, whether personal or business, with any client firm or any of its key staff.</p>
                        <br />

                        <p>•	Any non-public information received in a fiduciary capacity is held in trust and not used for personal gain or divulged in any manner.
                        </p><br />

                        <p>•	Furthermore, at company level, IIRA will only place deposits with Islamic banks and strictly adhere to the policy of not investing in any securities rated by IIRA or any securities issued by entities rated by IIRA.</p><br />

...
<ul class="sub">
    ...
    <div class="contact-container box-shadow site-width1 cf">
     <h1 class="box-title">Login Form</h1>
        ...
        <div class="form-container cf">
               ...
               <asp:TextBox ID="txtUserName" runat="server" placeholder="Enter your name here"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="rfvUser" ErrorMessage="Please enter Username" ControlToValidate="txtUserName" Font-Size="13px" runat="server" />

                    </div>    
                    <div>
                        <label for="name"> Password</label>
               <asp:TextBox ID="txtPWD" runat="server" placeholder="Enter your password here" TextMode="Password"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="rfvPWD" ErrorMessage="Please enter Password" ControlToValidate="txtPWD" Font-Size="13px" runat="server" />
    ...
    <div > 
                 <asp:Button ID="btnSubmit" runat="server" Text="Submit" onclick="btnSubmit_Click" />
                        ...
                        <!-- .box -->
             <div id="footer-container2" class="color white-text">
        <div id="footer">

...
<div class="about-wrapper site-width cf">
   ...
   <div class="about-sidebar">
               ...
               <div class="content">
                        ...
                        <h1 class="box-title">International Recognition</h1>
                            <br />
				
				<h2> <a  href="docs\CBB ECAI.pdf"  target="_blank">Central Bank of Bahrain (CBB)</a> </h2>
				<br />

                            <h2><a  href="docs\IIRA's-Recongnition-by-IDB.pdf"  target="_blank">Islamic Development Bank (IDB) </a></h2>
 
  			<br />
			<h2><a  href="docs\PR-ECAI-Jordan.pdf"  target="_blank">Central Bank of Jordan (CBJ)</a></h2></h2>
 			
			<br />
			<h2><a  href="docs\ECAI-IIRA-Kazakhstan.pdf"  target="_blank">Astana Financial Services Authority (AFSA), Kazakhstan</a></h2>

			<br />
			<h2><a  href="docs\PR-ECAI-Oman.pdf"  target="_blank">Capital Market Authority (CMA) of Sultanate of Oman</a></h2>
			<br />
			<h2><a  href="docs\PR-ECAI-Turkey-2016.pdf"  target="_blank">Banking Regulation & Supervisory Agency, Turkey</a></h2>
			<br />
			<h2><a  href="docs\CBOS Recognition Letter-Sudan.pdf"  target="_blank">Central Bank of Sudan (CBOS)</a></h2>
			<br />
			<h2><a  href="docs\RECOGNITION-NATIONAL INSURANCE REGULATORY AUTHORITY-SUDAN.pdf"  target="_blank">The National Insurance Authority Sudan</a></h2>
			<br />
			<h2><a  href="docs\SCEP Pakistan.pdf"  target="_blank">Securities and Exchange Commission of Pakistan</a></h2>
			<br />

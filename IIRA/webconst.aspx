<%@ Page Language="VB" AutoEventWireup="false" CodeFile="webconst.aspx.vb" Inherits="webconst" %>
    ...
    <ul class="sub">               
                                    ...
                                    <li><a href="whyrating.aspx" >Why Ratings?</a></li>
                                     <li><a href="ratingprocess.aspx">Rating process</a></li>
                                      ...
                                      <li><a href="webconst.aspx">Rating Scale</a></li>
                    ...
                    <li class="head-dropdown"><a href="resource.aspx">Resource center</a>
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="news.aspx">News and Briefings</a></li>
                                 ...
                                 <ul class="sub">
                                    <li><a href="webconst.aspx">Code of Ethics</a></li>
...
<div class="about-wrapper site-width ">
     <div class="box site-width">
            
            <div style="margin: 0 auto;
    color: #333333;
    padding: 30px;
    text-align: center;">
                <div style="    font-size: 224px;"><span class="fa fa-cog fa-spin"></span></div>
                <h1 style="margin-top: 20px;
    text-transform: uppercase;
    font-weight: bold;
    font-size: 50px;
    padding: 10px;">Under Development</h1>
                <p style="font-weight: lighter;
    font-size: 24px;
    line-height: 1.3em;">This page is currently under development and will be available soon.</p>
            </div>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="banksudan.aspx.vb" Inherits="loginpages_banksudan" %>
   ...
   <!-- <li><a href="maumlatindo.aspx" class="label">Bank Muamalat Indonesia</a><a style="display:none;" class="con" href="#">Indonesia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li> -->
	...
	<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Al Baraka Bank Sudan</h1>
                            </div>
                            <div class="tab">
                       ...
                       <img src="../images/albaraka.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                     		 ...
                     		 Established in 1984, Al Baraka Bank Sudan (‘ABS’ or ‘the bank’) is a directly owned subsidiary of Bahrain-based Al Baraka Banking Group 
			(ABG or ‘the group’ or ‘the parent’), a leading international Islamic Banking group. ABG holds a stake of 75.7% in 
			AlBaraka Bank Sudan, with the rest being held by local investors.<br>
			Listed on Khartoum Stock Exchange, Al Baraka Bank Sudan is primarily a retail bank and operates as a mid-tier bank in Sudan.
                                      </p>   
				</div>
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/ABBS - Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/ABBS - Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">March 2017</asp:LinkButton></td>
...
<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Al Baraka Bank Sudan
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABBS-Oct'2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Al Baraka Bank Sudan
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABBS-Mar'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                               <td class="nametd">Al Baraka Bank Sudan
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABBS-Jan'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

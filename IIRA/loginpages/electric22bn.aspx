<%@ Page Language="VB" AutoEventWireup="false" CodeFile="electric22bn.aspx.vb" Inherits="loginpages_electric22bn" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">K-ELECTRIC LIMITED</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/KE-Logo.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                     		The Islamic Republic of Pakistan is one of the most populous countries in the Islamic Ummah ranking second 
				after Indonesia, with a total population of 184.3m. The country is rich in natural resources, benefitting from 
				diverse climatic zones, a fertile soil and large reserves of coal and other mineral resources. A key strength is 
				its food production capability which goes beyond food sufficiency, with agriculture accounting for a major component 
				of the country’s exports after textiles. However, in relation to its sizable population, its per Capita GDP (PPP) 
				at USD 3,100 ranks 177 in the world. A significant portion, 56.4% of the country’s population falls within the age 
				bracket of 15 and 54, which augurs well for the economy’s potential, while at the same time requiring significant 
				investment to be made in areas such as education.
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton2" runat="server" CssClass="buttonClass">February 2019</asp:LinkButton></td>
   ...
   <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">K-ELECTRIC LIMITED
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\FR-KE-Feb'2019.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">K-ELECTRIC LIMITED
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-KE-Mar'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
							 ...
							 <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">K-ELECTRIC LIMITED
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-K-Electric-Mar'2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

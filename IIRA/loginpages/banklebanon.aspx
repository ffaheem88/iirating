<%@ Page Language="VB" AutoEventWireup="false" CodeFile="banklebanon.aspx.vb" Inherits="loginpages_banklebanon" %>
   ...
   <!--   <li><a href="maumlatindo.aspx" class="label">Bank Muamalat Indonesia</a><a style="display:none;" class="con" href="#">Indonesia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>  -->
	...
	<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                       ...
                       <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">AlBaraka Bank Lebanon S.A.L.</h1>
                            </div>
                            <div class="tab">
                       ...
                       <img src="../images/albaraka.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                     		...
                     		As the foremost Islamic banking franchise in the Republic of Lebanon (Lebanon or ‘the country’), AlBaraka Bank 
				Lebanon S.A.L. (ABBL or ‘the bank’) is one of five Islamic banks operating in the country, and ranking in as the most 
				significant Islamic Bank in terms of assets and branch network. However, it remains a small sized bank in the sector 
				as a whole. With 7 branches and growing, the bank has over time kept pace with other Islamic banks in terms of growth. 
				ABBL employs 150 staff as of June 2015, and provides a full suite of banking services to its customers. As a Middle 
				Eastern franchise, it stands to benefit from its associate network outside Lebanon.
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/ABBL - Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/ABBL - Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">April 2016</asp:LinkButton></td>
				...
				<br/>
						...
						<td class="nametd">AlBaraka Bank Lebanon S.A.L.
                            			  <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABBL-Apr'2016.pdf"  target="_blank">Press Release</a></li>
                                 		    </ul>
                                		</td>
                                                                <td>Lebanon</td>

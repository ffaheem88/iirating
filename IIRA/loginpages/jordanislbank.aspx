<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jordanislbank.aspx.vb" Inherits="loginpages_jordanislbank" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Jordan Islamic Bank</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/JIB-Logo.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      Jordan Islamic Bank (‘JIB’ or ‘the bank’) was established in 1978 and operates under the precepts 
			and principles of Islamic Shari’a. It is the oldest and largest amongst the four banks which provide 
			Islamic banking services in the Hashemite Kingdom of Jordan (‘Jordan’ or ‘the Kingdom’ or ‘the country’), 
			representing more than 50% of the sector’s deposit and asset base. In terms of the overall banking sector, 
			JIB ranks third in terms of total assets and total deposits. During 2015, JIB’s asset base1 and net financing 
			portfolio2 grew by 8% and 17%, respectively, outpacing the industry’s growth of 5%. As of end 2015, JIB’s 
			share of the total industry assets was 8.8% (2014: 8.6%) and the bank represented 8.4% (2014: 7.5%) of the 
			total financings. The bank’s share of the total industry deposits (including restricted investment accounts) 
			remained at prior year’s level at 11.5%. 
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/Jordan Islamic Bank- Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/Jordan Islamic Bank- Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton7" runat="server" CssClass="buttonClass">October 2018</asp:LinkButton></td>
				...
				<br/>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">November 2017</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">November 2016</asp:LinkButton></td>
 				...
 				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">September 2015</asp:LinkButton></td>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton5" runat="server" CssClass="buttonClass">December 2013</asp:LinkButton></td>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton6" runat="server" CssClass="buttonClass">December 2012</asp:LinkButton></td>
			...
			<tbody class="row">
                             			 ...
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Oct'2018.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
 			...
 			<tbody class="row">
                                                             <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Nov'2017.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
                                                        ...
                                                        <tbody class="row">
                                                             <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Nov'2016.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Sep'2015.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Feb2015.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
						...
						<tbody class="row">
                                                            <tr class="data">
                                                               <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Nov2013.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
						...
						<tbody class="row">
                                                            <tr class="data">
                                                                   <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-Dec'2012.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
                                                                <td>21-Dec-12</td>

 <%@ Page Language="VB" AutoEventWireup="false" CodeFile="ACWA-Power.aspx.vb" Inherits="loginpages_AcWA" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">International Company for Water & Power Projects (ACWA Power) </h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <p>
                      		 <img src="../images/ACWA.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                    	 	 ACWA Power is the largest private power developer in the Kingdom of Saudi Arabia (KSA) and the second largest in the GCC region. 
				The company is vertically integrated, with its wholly-owned subsidiary, First National Operation & 
				Maintenance Company Limited (NOMAC), being the Operational & Maintenance (O&M) contractor for
				 the company’s entire project portfolio. Presently, the company manages a portfolio of 38 project 
				companies generating power and water to the tune of over 27 GWs and 2.8m3/day respectively. 
				The company’s operations span across nine countries including KSA, Oman, Jordan, UAE, Turkey, 
				Vietnam, Morocco, South Africa and Bulgaria.
                                    </p> 
				</div>
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">February  2018</asp:LinkButton></td>
				 ...
				 <tbody class="row">
                             		 ...
                             		 <ul class="files">
                                            <li> &nbsp; &nbsp; <a class="pdf" href="PressRelease\PR-ACWA-Aug'2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
								...
								<td>71-75</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">International Company for Water & Power Projects (ACWA Power)
                             		 <ul class="files">
                                            <li> &nbsp; &nbsp; <a class="pdf" href="PressRelease\PR-ACWA-Feb'2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bankturk.aspx.vb" Inherits="loginpages_bankturk" %>
 ...
 <li><a  href="bankegypt.aspx" class="label">Al Baraka Bank Egypt</a><a style="display:none;" class="con" href="#">Egypt</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
	...
	<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                       ...
                       <img src="../images/ABG-Logo.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                     		...
                     		Albaraka Türk Katilim Bankasi A.Ş. (‘ALBRK’), a franchise of Albaraka Banking Group (ABG), operates as 
				a participation bank in Turkey. Incorporated in 1984, the bank initially operated as a Special Finance 
				House, and was converted to a full-fledged participation banking institution in 2005. ALBRK is 
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/Al Baraka Turk Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/Al Baraka Turk Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
...
<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton5" runat="server" CssClass="buttonClass">November 2018</asp:LinkButton></td>
...
<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">August 2017</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">February 2015</asp:LinkButton></td>
				 </tr>
			       </table>
...
<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">AlBaraka Bank Turk
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ATKB-Aug'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
 ...
 <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">AlBaraka Bank Turk
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ATKB-Nov'2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">AlBaraka Bank Turk
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ATKB-Aug'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">AlBaraka Bank Turk
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-AKTB-Feb'2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

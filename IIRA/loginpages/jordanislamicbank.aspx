<%@ Page Language="VB" AutoEventWireup="false" CodeFile="jordanislamicbank.aspx.vb" Inherits="loginpages_jordanislamicbank" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Jordan Islamic Bank &nbsp; (SQR)</h1>
                            </div>
                            <div class="tab">
			...
			remained at prior year’s level at 11.5%. 
				...
				<br/>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton6" runat="server" CssClass="buttonClass">January 2018</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">January 2016</asp:LinkButton></td>
				...
				<br/>    
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">February 2015</asp:LinkButton></td>
                                                    ...
                                                    <table>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th colspan="4" style="text-align:center;background:#D3D3D3;">SHARI'A QUALITY RATING </th>
                                                            </tr>
                                                            <tr>
...
<tbody class="row">
                             			 ...
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-SQR-Oct'2018.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
...
<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-SQR-Jan'2018.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\JIB-SQR-Dec'2016.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-SQR-Jan'16.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-SQR-Feb'15.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>
						...
						<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Jordan Islamic Bank
                             			 <ul class="files">
                                         		   <li> &nbsp; &nbsp; <a  href="PressRelease\PR-JIB-SQR-Feb13.pdf"  target="_blank">Press Release</a></li>
                                  		   </ul>
                               			 </td>
                                                                <td>Jordan</td>

                        ...
                        <div class="content" style="height:84vh;" >
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/TIIC.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
			...
			stake of 5.85% in the company.
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">November 2015</asp:LinkButton></td>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">March 2014</asp:LinkButton></td>
                            ...
                            <div id="History" class="tabcontent">
                              ...
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-IIC-Nov'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">The Islamic Insurance Company PLC
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-IIC-Nov'2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">The Islamic Insurance Company PLC
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-IIC-2014.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

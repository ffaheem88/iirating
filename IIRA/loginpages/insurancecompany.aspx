<%@ Page Language="VB" AutoEventWireup="false" CodeFile="insurancecompany.aspx.vb" Inherits="loginpages_insurancecompany" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Al Baraka Insurance Company</h1>
                            </div>
                            <div class="tab">
                       ...
                       <img src="../images/albaraka.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                     		...
                     		Established in 1985, Al Baraka Insurance Co. (“ABIC” or “the company”) is the second oldest takaful 
				operator in Sudan. As per management representations, the company is attempting to grow its market share
				 over the coming periods through product development and branch expansion. ABIC operates through a 
				network of 40 branches, having opened about 3-4 branches over the past few years, with further 6 
				planned for the ongoing financial year. The company also sells its services through agents and brokers.
                                    </p>  
				</div>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">July 2016</asp:LinkButton></td>
...
<tbody class="row">	
                              ...
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABIC-Nov'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                  ...
                                                  <td>Sudan</td>
                                                   <!-- <td>Fiduciary</td>-->
													...
													<td>BBB</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                       <td class="nametd">Al Baraka Insurance Company
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABIC-Jul'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="capitalbank.aspx.vb" Inherits="loginpages_capitalbank" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                         ...
                         <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">United Capital Bank</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/unitedcapital.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                     		United Capital Bank (‘UCB’ or ‘the bank’) is a small sized banking institution operating in the Republic of
				Sudan (‘Sudan’ or ‘the country’), holding a deposit market share of 1.4% as of Sep’16 (Dec’15: 1.7%).
				The bank was initially registered as a private limited company in Aug’2005, and it commenced
				operations in Aug’2006. Later, in Nov’2007, the bank was listed on the Khartoum Stock Exchange. While
				its shares are traded on the Khartoum Stock Exchange, shares in free-float are minimal. UCB operates
				via a network of 4 branches, situated in Khartoum, Khartoum North, Omdurman and Rabak. Staff
				strength of the bank stood at 157 as of Sep’16.
                                 </p> 
				</div>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton2" runat="server" CssClass="buttonClass">October 2018</asp:LinkButton></td>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">February 2017</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">March 2016</asp:LinkButton></td>
...
<tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">United Capital Bank
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-UCB-Oct'2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">United Capital Bank
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-UCB-Feb'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">United Capital Bank
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-UCB-Mar'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="republicofturkey.aspx.vb" Inherits="loginpages_republicofturkey" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Republic of Turkey</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/turkey-flag2.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                     		The investment grade rating assigned to the Republic of Turkey by Islamic International Rating Agency 
				is supported by sustained fiscal discipline and efficient borrowing strategies which have translated 
				into improved debt profile, reflected in reduced sensitivity to foreign exchange and interest rate 
				risks along with lengthening maturity profile. Overall debt levels have also come down in relation to 
				GDP over time. Turkey experienced slowdown in GDP growth rate to 2.8% in 9M14 as domestic demand remained 
				weak as a result of the dampening effect of higher interest rate environment and high inflation. 
				Growth in this period was however more balanced and was supported by exports, with exports representing 
				65.1% of imports in 2014 vis-à-vis 60.3% in 2013. Accordingly, Current Account Deficit (CAD) narrowed to 
				5.2% of GDP. The sharp decline in oil prices in international markets is likely to have a positive impact 
				on trade balance in terms of reducing oil import bill; this improvement may however not be sustainable in 
				nature as core drivers of the country’s balance of payments position continue to pose challenges, 
				particularly in the context of changes in global liquidity levels, and slowdown in Euro region along with 
				developments impacting key trading partners. Increasing external debt of the financial sector, most of 
				which is short term, also raises concerns regarding refinancing risk, amidst developments in the global 
				markets. While the assigned ratings are constrained to an extent by the external financing needs of the 
				country, sustained access to international markets in the past provides some comfort.
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/Turkey - Key Economic Indicators.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/Turkey - Key Economic Indicators.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
...
<p>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton6" runat="server" CssClass="buttonClass">Novemver 2018</asp:LinkButton></td>
...
<p>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton5" runat="server" CssClass="buttonClass">April 2017</asp:LinkButton></td>
				...
				<br/>
 				<p>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">March 2015</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">November 2013</asp:LinkButton></td>
				 ...
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">December 2012</asp:LinkButton></td>
                                            ...
                                            <div class="ratings-table" id="recent">
                                                <div class="data-table">
                                                    <table>
                                                        <thead>
                                                            <tr>
                                                                <th>&nbsp;&nbsp;Key Economic Indicators of Turkey</br>Amounts in US$'b, unless otherwise stated</th>
                                                                <th>2012</th>
                                                                <th>2013</th>
                                                                <th>2014</th>
                                                                <th>2015</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="data row heavy">
                                                                <td>Current Account Deficit as % of GDP</td>
                                                                <td> 5.5  </td>
                                                                <td> 6.7 </td>
                                                                <td> 4.7 </td>
                                                                <td> 3.8 </td>
                                                            ...
                                                            <tr class="data row heavy">
                                                                <td>Central Government Nominal Debt Stock as % of GDP</td>
                                                                <td>33.9</td>
                                                                <td>32.4</td>
                                                                <td>29.9</td>
                                                                <td>29.0</td>
                                                            ...
                                                            <tr class="data row heavy">
                                                                <td>Gross International Reserves</td>
                                                                <td> 137.5 </td>
                                                                <td> 147.8 </td>
                                                                <td> 141.8 </td>
                                                                <td> 128.0 </td>
...
<tbody class="row">
                              ...
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Turkey-2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">Republic of Turkey
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Turkey-Apr'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                      ...
                                                      <td>stable</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">Republic of Turkey
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Turkey-Mar2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                               <td class="nametd">Republic of Turkey
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Turkey-Nov2013.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
						...
						<tbody class="row">
                                                            <tr class="data">
                                                               <td class="nametd">Republic of Turkey
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Turkey-Dec'2012.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

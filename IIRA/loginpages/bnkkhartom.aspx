<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bnkkhartom.aspx.vb" Inherits="loginpages_bnkkhartom" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                       ...
                       <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">Bank of Khartoum</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/BoK-Logo.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                     		 Bank of Khartoum (‘BoK’ or ‘the bank’) is a retail banking institution operating in the Republic of the Sudan 
			(‘Sudan’ or ‘the country’). Established in 1913, the bank has undergone a series of transformations over its 
			103 years of operational history, which included nationalization in 1970 and privatization in 2002. The Government 
			of Sudan (GoS) continued to hold a controlling stake in the bank until 2005, when 60% of the bank’s ownership 
			was acquired by the UAE-based Dubai Islamic Bank (DIB). The bank’s merger in 2008 resulted in dilution in DIB’s 
			ownership, whilst also introducing a number of institutional and individual investors. 
                                    </p> 
				</div>
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">December 2015</asp:LinkButton></td>
				...
				<br/>
				 <table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton3" runat="server" CssClass="buttonClass">March 2015</asp:LinkButton></td>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton4" runat="server" CssClass="buttonClass">April 2014</asp:LinkButton></td>
				...
				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton5" runat="server" CssClass="buttonClass">January 2013 </asp:LinkButton></td>
                       ...
                       <tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">Bank of Khartoum
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-BoK-Jul'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
	   ...
	   <tbody class="row">
                                                            <tr class="data">
                                                                 <td class="nametd">Bank of Khartoum
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-BOK-Dec2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Bank of Khartoum
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-BoK-Mar2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Bank of Khartoum
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-BOK-Apr'2014.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
							...
							<tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">Bank of Khartoum
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-BOK-Feb'2013.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

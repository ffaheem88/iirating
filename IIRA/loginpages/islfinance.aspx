<%@ Page Language="VB" AutoEventWireup="false" CodeFile="islfinance.aspx.vb" Inherits="loginpages_islfinance" %>
...
<li><a href="ACWA-Power.aspx" class="label">International Company for Water & Power Projects (ACWA Power) </a><a style="display:none;" class="con" href="#">Saudi Arabia</a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                         ...
                         <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">aafaq Islamic Finance P.S.C</h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <div class="box box-shadow" style="padding:10px;" >
                                 <p>
                       <img src="../images/aafaq-Logo.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                     		aafaq Islamic Finance P.S.C Was in corporated November 2006 as a Private Joint Stock Company. 
				The company operates in the United Arab Emirates under a commercial license issued by the Department of 
				Economic Development, Government of Dubai and UAE Central Bank.<br>
				Licensed as an Islamic finance company, the scope of the company’s activities has included the provision of various over-the-counter services for government and/or government related and other private sector entities, included but not limited to, Ministry of Labor for issuance of labor guarantees, Ministry of Finance for issuance and top up facilities for E-Dirham cards and collection services for the Department of Economic Development. In addition to this, the company is also engaged in investing and financing activities.
                ...
                <div class="box box-shadow">
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="buttonClass">May 2015</asp:LinkButton></td>
				...
				<br/>
							...
							<td class="nametd">aafaq Islamic Finance P.S.C
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-Aafaq-Apr'2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

 <%@ Page Language="VB" AutoEventWireup="false" CodeFile="abcislbank.aspx.vb" Inherits="loginpages_abcislbank" %>
...
<div style="height:78vh;overflow-y: scroll;">
 ...
 <li><a href="AlbarakAlgeria.aspx.aspx" class="label">Banque Al Baraka D’Algerie </a><a style="display:none;" class="con" href="#">Algeria /a><a style="display:none;" class="typ" href="#">Bank Ratings</a></li>
                        ...
                        <div class="content" style="height:84vh;" >
                            <!-- .box -->
                            <div class="box">
                                <h1 class="box-title">ABC Islamic Bank </h1>
                            </div>
                            <div class="tab">
                            ...
                            <div id="Reports" class="tabcontent">
                                ...
                                <p>
                      		 <img src="../images/abc.png" height="50px" style="float:left;margin-right:10px;border-right:1px solid black;padding-right:10px;" />
                      
                    	 	 Bahrain based ‐ ABC Islamic Bank (‘ABCI’ or ‘the bank’), is a wholly owned subsidiary of Arab Banking
				Corporation BSC (‘ABC BSC’ or ‘the parent bank’) – a conglomerate of globally spread financial
				institutions, operating from 17 locations. Incorporated in 1985 as a financial services arm of the parent
				bank, it was spun off, in 1998, as an Islamic wholesale bank and renamed from ABC Investment &
				Services Co. (E.C.). The bank is the sole Shari’a compliant subsidiary of ABC BSC. With most of the control
				related functions being outsourced to the parent bank, ABCI’s own operations are conducted entirely from its Bahrain based head‐office, with a lean work force of 15 personnel.
                                    </p> 
				</div>
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="Reports/FS/ABC Islamic Bank- Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="Reports/FS/ABC Islamic Bank- Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
                ...
                <div class="box box-shadow">
  				...
  				<table>
                    		  ...
                    		  <td>
                         	 <asp:LinkButton ID="LinkButton2" runat="server" CssClass="buttonClass">January 2019</asp:LinkButton></td>
...
<tbody class="row">	
                                 <tr class="data">
								<td class="nametd">ABC Islamic Bank E.C.  
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABCI-Jan'2019.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
				...
				<tbody class="row">	
								...
								<td class="nametd">ABC Islamic Bank E.C.  
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABC-Sep'2017.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                  ...
                                                  <td>Bahrain</td>
                                                   <!-- <td>Fiduciary</td>-->
													...
													<td>-</td>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                          <td class="nametd">ABC Islamic Bank
                             		 <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABCI-Dec'2016.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
                                                        ...
                                                        <tbody class="row">
                                                            <tr class="data">
                                                                <td class="nametd">ABC Islamic Bank
                             		 <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="PressRelease\PR-ABCI-Nov'2015.pdf"  target="_blank">Press Release</a></li>
                                     </ul>

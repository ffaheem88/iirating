<%@ Page Language="VB" AutoEventWireup="false" CodeFile="resource.aspx.vb" Inherits="resource" %>
...
Serving the Islamic Ummah
    ...
    <ul class="sub">               
                  ...
                  <li class="head-dropdown"><a href="resource.aspx" class="current">Resource center</a>
         ...
         <div class="boxes-container site-width cf">
             ...
             <div class="about-sidebar">
                    <ul>
                                    ...
                                    <li><a href="resource.aspx" class="current">Methodology</a></li>
                                     <li><a href="news.aspx">News And Publications</a></li>
                                    <li><a href="presentation.aspx">Presentation</a></li>
            ...
            <strong>Sovereign Rating Policy And Methodology</strong>
                        <p class="date"></p>
                    </div>
                    <div class="desc"><p>IIRA’s sovereign rating methodology has been outlined to provide clarity on the economic and social
dimensions typically involved....</p>
<br /><p></p></div>
                   <div class="button">
   		    <a href="docs/Sovereign-Methodology.pdf" target="_blank">Sovereign Methodology 2012</a>
		    <a href="docs/Sovereign-Methodology-2017.pdf" target="_blank">Sovereign Methodology 2017</a>
		   </div> 
                 </div>
                
            <div class="box box-shadow">
                    <div class="title cf" style="font-weight: normal">
                <strong>Takaful Rating</strong>
                        <p class="date"></p>
                    </div>
                    <div class="desc"><p>Over the years, insurance had evolved on the “risk-sharing” concept (based on mutuality) and later transformed into a “risk-transferring” mechanism (particularly after introduction of stock companies...</p>
                    <p></p></div>
                    <div class="button"><a href="docs/Takaful-Methodology.pdf" target="_blank">Read More</a></div>
                </div>
 <div class="box box-shadow">
                    <div class="title cf" style="font-weight: normal">
                <strong>AWQAF RATING METHODOLOGY</strong>
                        <p class="date"></p>
                    </div>
                    <div class="desc"><p>Social enterprises and third sector1 organizations are growing in significance, globally, amidst
			frustrations with mounting violations of socio‐economic justic...</p>
                    <p></p></div>
                    <div class="button"><a href="docs/Awqaf-Rating-Methodology.pdf" target="_blank">Read More</a></div>
                </div>
        ...
        <%--************RightSide*************--%>     
            ...
            <%--................newbox...............--%>
             ...
             <div class="box box-shadow">
                    <div class="title cf" style="font-weight: normal">
                <strong>Fiduciary Methodology</strong>
                        <p class="date"></p>
                    </div>
                    <div class="desc"><p>The evolution of Islamic Finance as a parallel to conventional finance has gained significant global recognition in the past few decades. Islamic Finance is recognized as fundamentally different from conventional finance...</p><br />
                 
                    <p></p></div>
                    <div class="button"><a href="docs/Fiduciary-Methodology.pdf" target="_blank">Read More</a></div>
                </div>
		<div class="box box-shadow">
                    <div class="title cf" style="font-weight: normal">
                <strong>Shari’a Quality Rating Methodology</strong>
                        <p class="date"></p>
                    </div>
                    <div class="desc"><p>The “Shari’a” (Islamic Law) Quality Rating aims to provide information and independent assessment regarding the Shari’a governance framework of Islamic financial institutions...</p><br />
                 
                    <p></p></div>
                    <div class="button"><a href="docs/SQR-Methodology.pdf" target="_blank">Read More</a></div>
                </div>
